...
// app/home-view.tsx — AI Marketing Lab
// ============================================================================
// The homepage UI. Split out of app/page.tsx so that file can be a server
// component and export `metadata`: the metadata API is Server-Component-only,
// and this view needs hooks (canvas refs, scroll state, auth), so the two
// cannot live in one file. Same server-shell pattern as blog/[slug].
// ============================================================================
//
